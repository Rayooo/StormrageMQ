package com.ray.demo.loginconsumer3.service;
...
import com.ray.demo.loginconsumer3.dao.DemoUserDao;
...
public class UserService {
    ...
    public void addPoint(Message message){
        ...
        if(user != null && user.getId() != null && user.getUserName() != null){
            ...
            demoUserDao.updateUserTicket(user);
            LogUtil.logInfo("已为" + user.getUserName() + "修改了ticket");
        }
    }
